...
def compute_spectral_function(data, npoints=2000, sigma=0.1):
    """
...
def plot_multi_unfold(
    ...
    for i, (path, label, color, this_eref) in enumerate(
        ...
        eng, sf = compute_spectral_function(data, npoints=npoints, sigma=sigma)
    ...
    fig.savefig("BS_ele.png", dpi=dpi, bbox_inches="tight")
